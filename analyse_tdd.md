...
- [x] **MODIFIER :** Le test `'should have default values'` (lignes 6-15).
...
- [x] **MODIFIER :** Le test `'should validate required configuration'` (lignes 23-35).
...
- [x] **SUPPRIMER :** Le test `'should have all required methods defined'` (lignes 23-38).
...
- [x] **SUPPRIMER :** Tous les tests du fichier.
...
- [x] **FUSIONNER :** Les tests `'should create RoomModel with all required fields'` (lignes 8-33) et `'should create RoomModel with optional fields'` (lignes 35-51).
...
- [x] **FUSIONNER :** Les tests de statut individuels (lignes 146-196) dans `'should parse all room statuses correctly'`.
...
- [x] **FUSIONNER :** Les tests de conversion de statut (lignes 260-300) dans `'should convert all RoomStatus values correctly'`.
...
- [x] **FUSIONNER :** Les tests de couleur par valeur de carte (lignes 163-199).
...
- [x] **FUSIONNER :** Tous les tests de création de Failure (lignes 6-127) en un seul test paramétré.
...
- [x] **MODIFIER :** Remplacer l'utilisation de `StatefulBuilder` par des mocks appropriés.
...
- [x] **SUPPRIMER :** Le test `'should have placeholder methods for game actions'` (lignes 183-193).
...
- [x] **FUSIONNER :** Les tests `'should display "Votre grille" when isCurrentPlayer is true'` et `'should not display "Votre grille" when isCurrentPlayer is false'` (lignes 37-78).
...
- [x] **SUPPRIMER :** Le test vide dans le groupe `'_StatChip'` (lignes 321-326).
...
- [x] **MODIFIER :** Les noms de test pour plus de clarté.
...
- [x] **FUSIONNER :** Les tests d'échec similaires (lignes 113-274).
...
- [x] **CRÉER :** Un dossier `test/unit/` pour les tests unitaires purs.
  - **Justification :** Amélioration de l'organisation et séparation claire des types de tests.

- [x] **CRÉER :** Un dossier `test/integration/` pour les tests d'intégration.
  - **Justification :** Séparer les tests qui nécessitent plusieurs composants de ceux qui testent des unités isolées.

- [x] **CRÉER :** Des helpers de test réutilisables pour réduire la duplication.
...
- [x] **MODIFIER :** Les tests de calcul de score (lignes 16-51).
...
- [x] **SUPPRIMER :** La fonction helper qui expose l'implémentation (lignes 16-29).
...
- [x] **SIMPLIFIER :** Le test avec setup de 100+ lignes (lignes 70-163).
  - **Justification :** Violation du Principe n°4 (Bonne Granularité). Setup trop complexe qui rend le test difficile à comprendre.

- [x] **FUSIONNER :** Les tests redondants pour la pénalité double (lignes 165-234).
...
- [x] **MODIFIER :** Les tests vérifiant les appels de repository (lignes 62-96).
...
- [x] **FUSIONNER :** Les tests de validation redondants (lignes 98-134, 136-166).
  - **Justification :** Violation du Principe n°2 (Éliminer la Redondance). Structure identique pour différents cas de validation.

- [x] **MODIFIER :** Le test vérifiant `drawnCard` interne (lignes 280-316).
...
- [x] **SUPPRIMER :** Les tests de getters/setters (lignes 65-93).
  - **Justification :** Violation du Principe n°4 (Bonne Granularité). Tests triviaux des propriétés auto-générées.

- [x] **SIMPLIFIER :** Les tests de sérialisation (lignes 217-294).
...
- [x] **MODIFIER :** Le test d'égalité (lignes 336-383).
...
- [x] **MODIFIER :** Les tests de configuration de routes.
...
- [x] **MODIFIER :** Les tests de configuration Sentry.
...
- [x] **MODIFIER :** Les tests de configuration Supabase.
...
- [x] **SUPPRIMER :** Tous les tests de migration SQL.
...
- [x] **MODIFIER :** Les tests de providers pour tester le comportement.
...
- [x] **FUSIONNER :** Les tests d'affichage redondants.
...
- [x] **MODIFIER :** Les tests vérifiant la structure des widgets.
...
- [x] **FUSIONNER :** Les tests de vérification d'affichage.
...
- [x] **FUSIONNER :** Tous les tests de modèle en un test paramétré.
...
- [x] **MODIFIER :** Les tests pour vérifier le comportement utilisateur.
...
- [x] **MODIFIER :** Les tests vérifiant la distribution des cartes.
...
- [x] **FUSIONNER :** Les tests de validation du tour (lignes multiples).
...
- [x] **SIMPLIFIER :** Le setup complexe d'initialisation.
...
- [x] **MODIFIER :** Les tests vérifiant les flags internes.
...
- [x] **FUSIONNER :** Les tests de révélation par joueur.
...
- [x] **MODIFIER :** Le test vérifiant le changement de statut.
...
- [x] **SUPPRIMER :** Les tests de chargement JSON.
...
- [x] **SUPPRIMER :** Le test vérifiant l'interface.
...
- [x] **MODIFIER :** Les tests mockant Supabase.
...
- [x] **FUSIONNER :** Les tests de conversion to/from JSON.
...
- [x] **SIMPLIFIER :** Les tests de mapping complexes.
...
- [x] **FUSIONNER :** Les tests de modèle similaires.
...
- [x] **MODIFIER :** Les tests vérifiant les appels de datasource.
...
- [x] **FUSIONNER :** Les tests de repository similaires.
...
- [x] **SIMPLIFIER :** Les mocks Supabase complexes.
...
- [x] **SUPPRIMER :** Les tests de propriétés triviales.
...
- [x] **FUSIONNER :** Les tests de position en un seul.
...
- [x] **MODIFIER :** Les tests de création de carte.
...
- [x] **FUSIONNER :** Les tests d'état du deck.
...
- [x] **SUPPRIMER :** Les tests de propriétés du joueur.
...
- [x] **FUSIONNER :** Avec game_state_test.dart.
...
- [x] **FUSIONNER :** Les tests de conversion répétitifs.
