...
void main() {
  group('GameAnimationProvider V2 (Modern Syntax)', () {
    ...
    test('should hide direction change', () {
      ...
      notifier.showDirectionChange(PlayDirection.backward);
      expect(container.read(gameAnimationProvider).showingDirectionChange, true);
    ...
    test('should handle show-hide-show sequence', () {
      ...
      notifier.showDirectionChange(PlayDirection.forward);
      expect(container.read(gameAnimationProvider).showingDirectionChange, true);
      expect(container.read(gameAnimationProvider).direction, PlayDirection.forward);
      
      // Hide
      notifier.hideDirectionChange();
      expect(container.read(gameAnimationProvider).showingDirectionChange, false);
    ...
    test('auto-generated provider should be available', () {
      ...
      expect(provider is AutoDisposeNotifierProvider<GameAnimation, GameAnimationState>, true);
    });
  });
}