...
void main() {
  group('Card Entity', () {
    test(
      'should provide proper visual feedback based on value for player decision',
      () {
        ...
        final colorTestCases = [
          (
            ...
            'negative values should show as dark blue for low score',
          ),
          (
            -1,
            CardValueColor.darkBlue,
          ...
          (
            ...
            'zero should show as light blue for neutral score',
          ),
          (
            3,
            CardValueColor.green,
            'low positive values should show as green for good score',
          ),
          (
            7,
            CardValueColor.yellow,
            'medium values should show as yellow for warning',
          ),
          (
            11,
            CardValueColor.red,
            'high values should show as red for high penalty',
          ),
        ];
    ...
    test('should enforce valid card values for fair gameplay', () {
      ...
      expect(
        () => const Card(value: kMinCardValue),
        returnsNormally,
        reason: 'Minimum valid value should be allowed',
      );
      expect(
        () => const Card(value: kMaxCardValue),
        returnsNormally,
