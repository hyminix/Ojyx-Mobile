...
void main() {
  group('ActionCardRepository', () {
    ...
    test('should prevent adding more than 3 action cards', () {
      // Arrange
      final cards = List.generate(3, (i) => ActionCard(
        id: '$i',
        type: ActionCardType.teleport,
        name: 'Card $i',
    ...
    test('should shuffle action cards', () {
      // Arrange
      final cards = List.generate(10, (i) => ActionCard(
        id: '$i',
    ...
    test('should handle multiple players independently', () {
      ...
      expect(repository.getPlayerActionCards('player1'), isNot(contains(card2)));
      expect(repository.getPlayerActionCards('player2'), contains(card2));
      expect(repository.getPlayerActionCards('player2'), isNot(contains(card1)));
    });
  });
}