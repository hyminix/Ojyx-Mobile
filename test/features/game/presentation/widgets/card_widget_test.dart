...
void main() {
  group('CardWidget', () {
    testWidgets('should display placeholder when isPlaceholder is true', (tester) async {
      // Arrange & Act
    ...
    testWidgets('should display hidden card when card is not revealed', (tester) async {
      // Arrange
    ...
    testWidgets('should display card value when revealed', (tester) async {
      ...
      // Assert
      expect(find.text('7'), findsNWidgets(3)); // Value shown 3 times (top-left, center, bottom-right)
    ...
    testWidgets('should handle long press when onLongPress is provided', (tester) async {
      // Arrange
    ...
    testWidgets('should show selection border when isSelected is true', (tester) async {
      // Arrange
      const card = game.Card(
        value: 2,
        isRevealed: true,
    ...
    testWidgets('should show highlight border when isHighlighted is true', (tester) async {
      // Arrange
      const card = game.Card(
        value: 4,
        isRevealed: true,
    ...
    testWidgets('should display nothing when card is null and not placeholder', (tester) async {
      // Act
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(
    ...
    testWidgets('should apply correct color based on card value', (tester) async {
      ...
      for (final (value, expectedColor) in testCases) {
        ...
        // Assert
        final textWidgets = tester.widgetList<Text>(find.text(value.toString()));
