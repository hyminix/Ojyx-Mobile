...
void main() {
  ...
  group('Repository Providers', () {
    test('gameStateRepositoryProvider should return SupabaseGameStateRepository', () {
      // Act
    ...
    test('serverActionCardRepositoryProvider should return ServerActionCardRepository', () {
      // Act
    ...
    test('serverActionCardRepositoryProvider should use the same supabase client', () {
      // Act
      final repository = container.read(serverActionCardRepositoryProvider);
      final supabaseClient = container.read(supabaseClientProvider);
    ...
    test('providers should be singleton instances', () {
      ...
      final actionRepository1 = container.read(serverActionCardRepositoryProvider);
      final actionRepository2 = container.read(serverActionCardRepositoryProvider);
