...
void main() {
  group('PlayerGridModel', () {
    test(
      'should preserve competitive game state when converting to domain entity',
      () {
    ...
    test(
      'should maintain game integrity when converting to database format',
      () {
        ...
        final gridModel = PlayerGridModel(
          ...
          gameStateId: 'game-1',
          playerId: 'player-1',
          gridCards: List.generate(
            12,
            (i) => {'value': i, 'is_revealed': false},
          ),
          actionCards: [],
          score: 25,
          position: 1,
    ...
    test(
      'should maintain data integrity through API serialization for reliable multiplayer synchronization',
      () {
        ...
        for (final scenario in scenarios) {
          ...
          expect(
            json.containsKey('has_revealed_all'),
            isTrue,
          ...
          if (scenario.expectations['all_revealed'] == true) {
            ...
            expect(
              ...
              equals(12),
              reason:
                  '${scenario.name}: Endgame should have all cards revealed',
            );
          }

          if (scenario.expectations['action_cards_empty'] == true) {
            expect(
              deserialized.actionCards,
              isEmpty,
          ...
          if (scenario.expectations['inactive_state'] == true) {
            expect(
              ...
              isFalse,
              reason:
                  '${scenario.name}: Disconnected player should be inactive',
            );
          }
        }
      },
