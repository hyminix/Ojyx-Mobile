...
void main() {
  group('Room Creation Use Case for Competitive Multiplayer Gaming Coordination', () {
    ...
    test('should successfully establish competitive rooms for strategic multiplayer gaming experiences', () async {
      ...
      expect(createdRoom.playerIds, [strategicHostId], reason: 'Host should be the initial participant in competitive room');
    ...
    test('should enforce competitive gaming constraints to ensure fair and strategic multiplayer experiences', () {
      ...
      expect(
        ...
        reason: 'Single-player rooms should be rejected to ensure multiplayer competitive experiences'
      );
      ...
      expect(
        ...
        throwsA(isA<ArgumentError>()),
        reason: 'Oversized rooms should be rejected to maintain strategic competitive balance'
      );
    });
  });
}
