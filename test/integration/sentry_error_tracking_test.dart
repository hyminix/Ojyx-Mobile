...
void main() {
  ...
  group('Sentry Error Tracking Integration Tests', () {
    ...
    test('should handle nested performance spans', () async {
      ...
      await sentryService.measurePerformance('main-operation', () async {
      ...
      await tester.pumpWidget(
        MaterialApp(
          home: SentryPerformanceWidget(
            ...
            child: const Scaffold(body: Center(child: Text('Test Screen'))),
          ),
        ),
      );
