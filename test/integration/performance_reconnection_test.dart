...
void main() {
  ...
  group('Performance and Reconnection Integration Tests', () {
    ...
    setUp(() {
      ...
      connectivityService = ConnectivityService.createWithConnectivity(mockConnectivity);
...
''');
    ...
    group('Reconnection Tests', () {
      ...
      test('should persist and restore state during reconnection', () async {
        when(() => mockPrefs.setString(any(), any())).thenAnswer((_) async => true);
        when(() => mockPrefs.getString('app_state')).thenReturn('{"score": 100}');
    ...
    group('Integration Stress Tests', () {
      ...
      test('should maintain performance under load', () async {
        ...
        print('Heavy load test completed in: ${stopwatch.elapsedMilliseconds}ms');
      });
    });
  });
}