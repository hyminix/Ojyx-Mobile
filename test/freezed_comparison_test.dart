...
void main() {
  group('Freezed Files Comparison', () {
    test('should compare freezed files after update', () {
      ...
      if (differences.isEmpty) {
        print('✅ Aucune différence détectée dans les fichiers freezed');
        print('   Version freezed: 2.5.7 (déjà à jour)');
      } else {
        print('⚠️ Différences détectées dans ${differences.length} fichier(s) freezed:');
      ...
      expect(differences.isEmpty, isTrue,
          reason: 'Freezed files should not change with current version');
    });
  });
}