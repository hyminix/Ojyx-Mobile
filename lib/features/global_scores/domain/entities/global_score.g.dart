...
_GlobalScore _$GlobalScoreFromJson(Map<String, dynamic> json) => $checkedCreate(
  '_GlobalScore',
  json,
  ($checkedConvert) {
    final val = _GlobalScore(
...
Map<String, dynamic> _$GlobalScoreToJson(_GlobalScore instance) =>
    <String, dynamic>{
      'id': instance.id,
...
_PlayerStats _$PlayerStatsFromJson(Map<String, dynamic> json) => $checkedCreate(
  '_PlayerStats',
  json,
  ($checkedConvert) {
    final val = _PlayerStats(
      playerId: $checkedConvert('player_id', (v) => v as String),
      playerName: $checkedConvert('player_name', (v) => v as String),
