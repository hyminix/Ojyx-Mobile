...
class SaveGlobalScoreUseCase implements UseCase<List<GlobalScore>, SaveGlobalScoreParams> {
  ...
  @override
  Future<Either<Failure, List<GlobalScore>>> call(SaveGlobalScoreParams params) async {
    try {
      ...
      for (int i = 0; i < sortedPlayers.length; i++) {
        ...
        scores.add(GlobalScore(
          ...
          roundNumber: params.roundNumber ?? 1, // Round number should be passed as parameter
          position: i + 1,
