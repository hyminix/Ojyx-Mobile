...
_$GlobalScoreModelImpl _$$GlobalScoreModelImplFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
  r'_$GlobalScoreModelImpl',
  json,
  ($checkedConvert) {
    final val = _$GlobalScoreModelImpl(
...
Map<String, dynamic> _$$GlobalScoreModelImplToJson(
  _$GlobalScoreModelImpl instance,
) => <String, dynamic>{
  'id': instance.id,
