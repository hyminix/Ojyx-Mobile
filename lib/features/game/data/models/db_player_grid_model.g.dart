...
_DbPlayerGridModel _$DbPlayerGridModelFromJson(Map<String, dynamic> json) =>
    $checkedCreate(
      '_DbPlayerGridModel',
      json,
      ($checkedConvert) {
        final val = _DbPlayerGridModel(
...
Map<String, dynamic> _$DbPlayerGridModelToJson(_DbPlayerGridModel instance) =>
    <String, dynamic>{
      'id': instance.id,
