...
abstract class $CardCopyWith<$Res> {
  ...
  @useResult
  $Res call({int value, bool isRevealed});
}
...
class _$CardCopyWithImpl<$Res, $Val extends Card>
  ...
  @override
  $Res call({Object? value = null, Object? isRevealed = null}) {
    return _then(
      _value.copyWith(
            value: null == value
                ? _value.value
...
class _$CardImpl extends _Card {
  const _$CardImpl({required this.value, this.isRevealed = false})
...
abstract class _Card extends Card {
  const factory _Card({required final int value, final bool isRevealed}) =
      _$CardImpl;
