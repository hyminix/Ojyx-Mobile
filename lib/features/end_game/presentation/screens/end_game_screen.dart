...
import 'package:ojyx/features/end_game/presentation/providers/end_game_provider_v2.dart';
...
class EndGameScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final endGameState = ref.watch(endGameStateNotifierProvider);

    return Scaffold(
      body: endGameState == null
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // GamePlayer rankings
                      ...endGameState.rankedPlayers.asMap().entries.map((
                        entry,
                      ) {
                      ...
                      VoteSection(
                        ...
                        onEndGame: () {
                          ref.read(endGameActionProvider.notifier).endGame();
                        },
                      ),
                    ],
                  ),
